 ...
 * @see https://extsvnsrv.fokus.fraunhofer.de/cc/elan/OGDD/ticket/37 dataset-portlet: Kategorien und Schlagworte anklickbar
 */
@ManagedBean
@SessionScoped
    ...
    public String onClick() {
        ...
        if (responseObject != null && responseObject instanceof ActionResponse) {
            ...
            if (!clickedCategory.isEmpty()) {
                query.getCategories().add(clickedCategory);
                clickedCategory = "";
            } else if (!clickedTag.isEmpty()) {
                query.getTags().add(clickedTag);
                clickedTag = "";
            }
            ...
            try {
                ...
                String currPage = layout.getFriendlyURL(); // currPage may be /suchen /daten, etc.
                location += currPage;
