...
/**
 * Indicates wether userfeedback exists or not. UI can handle the state with (in
 * JSF EL) #{feedback.XXX}
 * 
...
public class Feedback implements Serializable {
     ...
     * 
     * @param metadataAppCreated
     *            the metadataAppCreated to set
     */
     ...
     * 
     * @param metadataCommentCreated
     *            the metadataCommentCreated to set
     */
