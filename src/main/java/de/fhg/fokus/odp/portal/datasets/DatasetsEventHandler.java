...
public class DatasetsEventHandler implements BridgeEventHandler, Serializable {
    ...
    public EventNavigationResult handleEvent(FacesContext facesContext, Event event) {
        ...
        if (eventQName.equals("{http://fokus.fraunhofer.de/odplatform}querydatasets")) {
        ...
        } else if (eventQName.equals("{http://fokus.fraunhofer.de/odplatform}metadataAppCreated")) {
    ...
    protected QueryManager getQueryManagerBean(FacesContext facesContext) {
        ...
        ValueExpression valueExpression = facesContext.getApplication().getExpressionFactory()
                .createValueExpression(elContext, elExpression, QueryManager.class);
